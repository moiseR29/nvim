...
" CocInstall
" coc-tsserver coc-terminal coc-snippets coc-sh coc-json coc-html coc-eslint
...
" Use tab for trigger completion with characters ahead and n<>avigate.
...
nmap <silent> gdd :call CocAction('jumpDefinition', 'vsplit')<CR>
